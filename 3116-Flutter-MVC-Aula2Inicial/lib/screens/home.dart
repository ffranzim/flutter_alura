    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Center(
          ...
          child: FutureBuilder(
            future: bookController.getPersonalBooks(),
                ...
                itemBuilder: (context, index) => InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => BookDetails(personalBook: widget.listPersonalBook[index],
                        ),
                      ),
                    ).then((value) async {
                      widget.listPersonalBook = await bookController.getPersonalBooks();
                      setState(() { });
                    });
                  },
                  child: Image.network(
